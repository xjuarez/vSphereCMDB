...
############################################################################################
#$vCenterCredentials = IMPORT-CLIXML ".\vCenterCredentials.xml"
############################################################################################
...
#}
#"----------------------------"
#"Connecting vCenter:$vCenterServer
...
INSERT INTO Hosts (LastUpdated, HostID, Name, VMs, VMDisks, VMNICs, Datastores, PortGroups, State, ConnectionState, PowerState, NumCpu, CpuTotalMhz, CpuUsageMhz, MemoryTotalGB, 
...
INSERT INTO Clusters (LastUpdated, ClusterID, Name, Hosts, VMs, VMDisks, VMNICs, Datastores, DrsEnabled, DrsMode, DrsAutomationLevel, HAEnabled, HAAdmissionControlEnabled, HAFailoverLevel, HARestartPriority, 
...
INSERT INTO Datacenters (LastUpdated, DatacenterID, Name, Clusters, Hosts, VMs, VMDisks, VMNICs, Datastores, PortGroups, CustomFields, ParentFolderId, ParentFolder, Uid, DatastoreFolderId)
...
############################################################################################
# Desconectando del vCenter
############################################################################################
#"----------------------------"
#"Disconnecting vCenter:$vCenterServer"
